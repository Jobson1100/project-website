  ...
  <header id="site-header" class="fixed-top">
    <div class="container">
      <nav class="navbar navbar-expand-lg stroke">
        <h1><a class="navbar-brand mr-lg-5" href="basic.php">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="basic.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="b_about.php">About</a>
            </li>
            ...
            <div class="slider-info  banner-view banner-top1 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-left">
                    <p>Dream Home</p>
                    <h5>Everyone Deserves the Opportunity to build their dream house</h5>
                    <a href="b_about.php" class="btn btn-white">Read More</a>
                  </div>
                </div>
              </div>
              <div class="banhny-w3grids">
            ...
            <div class="slider-info banner-view banner-top3 bg bg2">
              <div class="banner-info">
                <div class="container">
                  <div class="banner-info-bg text-left">
                    <p>Dream Home</p>
                    <h5>Everyone Deserves the Opportunity of House</h5>
                    <a href="b_about.php" class="btn btn-white">Read More</a>
                  </div>
                </div>
              </div>
    ...
    <div class="container py-md-5">
      <div class="row bottom-ab-grids align-items-center">
        <div class="col-lg-6 bottom-ab-left pr-lg-5">
          ...
          <h3 class="hny-title">
            Recent deals closed by some of our clients</h3>
          ...
          <a href="b_about.php" class="btn btn-style btn-secondary mt-4">Read More</a>
        </div>
	...
	<div class="pricing11 py-5">
          ...
          <h3 class="hny-title">Budget Packages</h3>
			...
			<div class="pricing11-content">
				<div class="column pricing-grid">
					...
					<div class="rate">
						<h5><span class="top-align">from</span> K2 million - K5 million</h5>
					</div>
					<p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
					<button class="button"><a href="login.php">Choose budget</a></button>
				...
				<div class="column pricing-grid pricing-grid-active">
					...
					<div class="rate">
						...
						<h5><span class="top-align">from</span> K6 million - K10 million</h5>
					</div>
					<p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
					<button class="button"><a href="login.php">Choose budget</a></button>
					<div class="text-center">
				...
				<div class="column pricing-grid">
					...
					<div class="rate">
						<h5><span class="top-align">from</span> K10 million - K20 million </h5>
					</div>
					<p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
          <button class="button"><a href="login.php">Choose budget</a></button>
					<div class="text-center">
      ...
      <div class="pricing11-content">
          <div class="column pricing-grid">
            ...
            <div class="rate">
              <h5><span class="top-align">from</span> K21 million - K25 million</h5>
            </div>
            <p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
            <button class="button"><a href="login.php">Choose budget</a></button>
            <div class="text-center">
          ...
          <div class="column pricing-grid pricing-grid-active">
            ...
            <div class="rate">
              ...
              <h5><span class="top-align">from</span> K26 million - K30 million</h5>
            </div>
            <p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
            <button class="button"><a href="login.php">Choose budget</a></button>
            <div class="text-center">
          ...
          <div class="column pricing-grid">
            ...
            <div class="rate">
              <h5><span class="top-align">from</span> K31 million - Above </h5>
            </div>
            <p>Integer blandit eget dui in tempor lorem. gravida tortor at eros sed et.</p>
            <button class="button"><a href="login.php">Choose budget</a></button>
            <div class="text-center">
...
<!-- //pricing11 -->
  ...
  <section class="w3l-grid-quote text-center py-5">
    <div class="container py-3">
      <h6 class="sub-title text-center">Want to get started?</h6>
      <h3 class="hny-title mb-md-5 mb-4">Click below to start a Project!</h3>
      <a href="login.php" class="btn btn-style btn-primary mr-2">Get started</a>
      <a href="login.php" class="btn btn-style btn-outline-primary">Get in touch</a>
    </div>
  </section>
  <!--//get -->
  <!--/w3l-footer-29-main-->
        ...
        <div class="container">
              ...
              <div class="row">
                <div class="col-md-4 column">
                  ...
                  <ul class="footer-gd-16">
                    ...
                    <li><a href="b_about.php">About Us</a></li>
                ...
                <div class="col-md-4 column mt-md-0 mt-4">
                  ...
                  <ul class="footer-gd-16">
                    ...
                    <li><a href="b_about.php">About Company</a></li>
                ...
                <div class="col-md-4 column mt-md-0 mt-4">
                  ...
                  <ul class="footer-gd-16">
                    ...
                    <li><a href="basic.php">Landing Page</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="d-flex below-section justify-content-between align-items-center pt-4 mt-5">
            <div class="columns text-lg-left text-center">
              <p>&copy; 2023 NEHUWA Engineering. All rights reserved.
              </p>
            </div>
