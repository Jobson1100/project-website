  ...
  <section class="w3l-cta4 py-5">
      <div class="container py-lg-5">
        <div class="ab-section text-center">
          ...
          <h3 class="hny-title">Everyone Deserves the Opportunity of Building their dream house</h3>
          <p class="py-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum labore sed, veniam nisi sunt laboriosam ducimus, odio
            ...
            <a href="register.php" class="btn btn-white">Sign Up for More Info</a>
        ...
        <div class="container">
          ...
          <div class="d-flex below-section justify-content-between align-items-center pt-4 mt-5">
            <div class="columns text-lg-left text-center">
              <p>&copy; 2023 Homish. All rights reserved.
              </p>
            </div>
